...
public class Controller {
	...
	public ResponseEntity<Response> save(@Valid @RequestBody Patient patient){
	...
	@GetMapping(path = "/findByNameLastName")
	public ResponseEntity<Response> findByNameLastName(@RequestParam(name = "name") String name, @RequestParam(name = "lastName") String lastName){
		Response response = services.findByNameLastName(name, lastName);
		return new ResponseEntity<>(response, HttpStatus.FOUND);
	}
